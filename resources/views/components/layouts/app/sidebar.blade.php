...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        ...
        <!-- Mobile User Menu - POSITION FIXED -->
        <flux:header class="lg:hidden fixed top-0 left-0 right-0 z-50 bg-zinc-800 border-b border-zinc-700">
        ...
        <main class="lg:ml-64 pt-[64px] lg:pt-0">
            {{ $slot }}
        </main>
